      ...
      <main className="flex-1 p-8">
        ...
        <header className="flex justify-between items-center mb-10">
          ...
          <div className="flex gap-4">
            <button className="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-bold hover:bg-blue-700 transition-colors shadow-md">
              + Create Task
            </button>
            <Link
              to="/login"
        ...
        {/* Content Grids (Team List & Task List) */}
              ...
              <div className="p-4 border border-gray-100 rounded-xl flex justify-between items-center hover:shadow-md transition-shadow">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Assigned to: Usama • Team: Frontend Devs
                  </p>
                </div>
